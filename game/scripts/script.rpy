...
label intro:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0040_centered_498fd4e029.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0048_narrator_voice_60d854ee2d.mp3"  # edge-tts-auto
    narrator_voice "The year is 2013."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0050_narrator_voice_3d785b1c36.mp3"  # edge-tts-auto
    narrator_voice "The United States government operates the most sophisticated surveillance network in human history."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0052_narrator_voice_9033272771.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0054_narrator_voice_e8cd561b81.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0056_narrator_voice_f2819080db.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0058_narrator_voice_07620b7385.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0060_narrator_voice_a83d33ea70.mp3"  # edge-tts-auto
...
label chapter_1:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0090_narrator_voice_ee56538242.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0093_narrator_voice_75301c64a2.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0099_im_11a04abf8d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0101_im_59a24c7f78.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0106_supervisor_5785c8bc75.mp3"  # edge-tts-auto
    supervisor "Morning. We've got a batch of flagged selectors to process. XKeyscore caught some interesting traffic overnight."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0108_im_e0aa67074b.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0110_e_3bdec1ed93.mp3"  # edge-tts-auto
    e "Yes sir. I'll pull up the queue."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0112_supervisor_770fb54ab3.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0114_im_94aaa1c8af.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0119_colleague_4a9f75415d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0123_e_26204e54a6.mp3"  # edge-tts-auto
    e "That's... that's a lot of access for an unflagged individual."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0125_colleague_015681c759.mp3"  # edge-tts-auto
    colleague "Welcome to the NSA, man. Everything is accessible. Everything."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0127_im_781b92a2f0.mp3"  # edge-tts-auto
    ...
    menu:
        "Follow protocol. Process the flagged selectors as assigned.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0136_e_9d17450c4f.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0143_im_307dd592a0.mp3"  # edge-tts-auto
            im "Stay in your lane. Do your job. Don't attract attention."

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0145_narrator_voice_7527edd93e.mp3"  # edge-tts-auto
        ...
        "Explore the restricted directories. Something doesn't add up.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0149_e_fe84e14588.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0156_im_d1d64d862c.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0158_narrator_voice_0f4ff8ada0.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0163_narrator_voice_55e820c9e1.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0165_im_5f6eec9a80.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0167_im_e694910cf2.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0171_im_eec84f98f6.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0173_im_f94577b410.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0175_im_929840e763.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0181_im_8e6ca2bb8d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0183_im_cf2680b6e9.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0185_im_ec0d361e61.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0187_im_b44bfa8559.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0189_im_d51eb3475e.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0195_im_59a0b4431d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0197_im_78673241bd.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0199_im_1589427d72.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0205_im_0f61e81ff3.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0236_im_9f416f5605.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0238_im_e268013e05.mp3"  # edge-tts-auto
    ...
    menu:
        "Report the anomaly to the Inspector General's office.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0267_e_4192d53a49.mp3"  # edge-tts-auto
            e "I should file a formal concern with the IG office."
            $ trust_score += 2
            $ renpy.notify(t("Trust +2"))

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0271_supervisor_76a55fc4a9.mp3"  # edge-tts-auto
            supervisor "Do what you have to do. But I'm telling you, this goes nowhere."

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0273_im_033822e349.mp3"  # edge-tts-auto
            im "I filed the report. I used the proper channels. And nothing happened. Nothing."

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0275_narrator_voice_3199460e04.mp3"  # edge-tts-auto
        ...
        "Stay silent. Keep working. Gather more information.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0280_im_a4e52f8225.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0284_narrator_voice_6162d06c6d.mp3"  # edge-tts-auto
...
label chapter_2:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0328_im_2e326eef4c.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0330_im_efcc95c2c6.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0334_im_f1251797b7.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0336_narrator_voice_77b9d8c1a0.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0340_im_f2d4656586.mp3"  # edge-tts-auto
    ...
    menu:
        "Trust the colleague. Share what you've found.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0363_e_d29c3890ed.mp3"  # edge-tts-auto
            e "Look, I need someone I can trust. What I've found... it's bigger than both of us."
            $ trust_score += 1
            $ renpy.notify(t("Trust +1"))

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0367_colleague_b1f728ff19.mp3"  # edge-tts-auto
        ...
        "Work alone. Trust no one inside the NSA.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0380_colleague_bf883e00f9.mp3"  # edge-tts-auto
            colleague "Sure, man. Get some rest."

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0382_im_f7cbf9244c.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0410_im_0a77ab4f24.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0414_im_3f7e89cc2a.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0416_im_2b8351cefd.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0422_im_335222a36b.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0424_im_8491dde7a2.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0430_im_5e140eee7d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0432_im_605e2d296e.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0443_im_684edc309d.mp3"  # edge-tts-auto
    im "I have access to everything. The question is: what do I do with it?"

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0445_narrator_voice_07e4a37dd7.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0447_im_9fe9075e74.mp3"  # edge-tts-auto
    ...
    menu:
        "Copy the files to an encrypted drive. This evidence needs to survive.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0452_im_cf7e96c150.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0457_narrator_voice_dcd9171040.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0459_im_266772a259.mp3"  # edge-tts-auto
        ...
        "Take detailed notes only. Digital evidence is too risky.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0465_im_0b30966268.mp3"  # edge-tts-auto
            im "If they catch me with files, it's espionage. Notes are deniable."
            $ trust_score -= 1
            $ renpy.notify(t("Trust -1"))

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0469_narrator_voice_6f1dede966.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0475_im_5c8629f9f5.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0477_im_164d2c4b13.mp3"  # edge-tts-auto
...
label chapter_3:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0526_im_2af3641301.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0528_narrator_voice_1c10ffdb91.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0530_im_f82178ec5b.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0534_im_07dbd272ca.mp3"  # edge-tts-auto
    ...
    if suspicion_level >= 3:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_0538_narrator_voice_e35f399c18.mp3"  # edge-tts-auto
        ...
        menu:
            "Try to bluff your way through the security review.":
                ...
                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_0548_im_52d32e4674.mp3"  # edge-tts-auto
                im "I told them I was running diagnostic tests on the archival system. They seemed to buy it... for now."

                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_0550_narrator_voice_d205792db4.mp3"  # edge-tts-auto
            ...
            "Accelerate the timeline. Contact journalists immediately.":
                ...
                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_0557_im_b77fbfd1a5.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0563_im_e641cbfc21.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0565_im_de4a500529.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0567_narrator_voice_b6587fb3cb.mp3"  # edge-tts-auto
...
label ch3_secure_success:
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0590_im_52b20f96da.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0600_narrator_voice_87feb29d1c.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0605_poitras_fdef4d576d.mp3"  # edge-tts-auto
    poitras "I received your encrypted message. The fingerprint checks out. Who are you?"

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0607_e_5e1760be50.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0610_poitras_faa0fe73be.mp3"  # edge-tts-auto
    poitras "Can you prove it?"

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0612_e_109e59ac6d.mp3"  # edge-tts-auto
...
label ch3_secure_fail:
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0617_im_ca45b5c746.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0624_narrator_voice_941572744c.mp3"  # edge-tts-auto
...
label ch3_greenwald_contact:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0634_narrator_voice_7aaee15875.mp3"  # edge-tts-auto
    narrator_voice "You reach out to Grayson Wardell through his public contact information. It's faster, but less secure."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0636_e_9331997bd9.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0639_greenwald_330eca30ef.mp3"  # edge-tts-auto
    greenwald "I get messages like this every week. Can you give me more details?"

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0641_e_6697848307.mp3"  # edge-tts-auto
    e "Not over this channel. You need to set up PGP encryption. I'll send you instructions."

    show greenwald confused
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0644_greenwald_4a6482d32d.mp3"  # edge-tts-auto
    greenwald "PGP? I've never used it. Can't we just talk on the phone?"

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0646_im_4c5743d6b5.mp3"  # edge-tts-auto
...
label ch3_wait:
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0654_narrator_voice_223e24c66a.mp3"  # edge-tts-auto
    narrator_voice "You decide to wait for a safer window. But there may not be one."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0656_im_ea0105827a.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0661_narrator_voice_498387062f.mp3"  # edge-tts-auto
...
label ch3_contact_unsafe:
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0666_narrator_voice_3074d89f5b.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0672_im_55c347446f.mp3"  # edge-tts-auto
...
label ch3_continue:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0684_im_dd547c12c6.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0686_im_59b14bccbb.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0699_im_b322b94141.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0701_im_b36c7534d1.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0705_im_9136e48dd3.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0711_im_ea5b414976.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0717_im_875676bfee.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0723_im_4f64fd4622.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0729_im_fca9c08baf.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0761_narrator_voice_d0803e0aea.mp3"  # edge-tts-auto
    narrator_voice "The journalist asks for more details about the scope of the leaks."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0763_greenwald_604e7a534c.mp3"  # edge-tts-auto
    ...
    menu:
        "Tell everything. Full transparency builds trust.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0768_e_cc47cfec45.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0774_greenwald_952456c22e.mp3"  # edge-tts-auto
        ...
        "Share only what's necessary. Protect sources and methods.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0778_e_4b7bf703aa.mp3"  # edge-tts-auto
            e "I can confirm the NSA is conducting mass domestic surveillance. I'll share the details when we meet in person."
            $ trust_score += 1
            $ renpy.notify(t("Trust +1"))

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0782_greenwald_d98ee4013e.mp3"  # edge-tts-auto
        ...
        "Be vague. Don't reveal the scope until you're safe.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0786_e_0a5429a12e.mp3"  # edge-tts-auto
            e "It's significant. That's all I can say right now."
            $ trust_score -= 1
            $ renpy.notify(t("Trust -1"))

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0790_greenwald_d729d0286d.mp3"  # edge-tts-auto
...
label chapter_4:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0836_narrator_voice_fe3b65f13f.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0838_im_472a6ffe85.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0840_im_60836f14dd.mp3"  # edge-tts-auto
    im "I told my employer I needed medical leave for epilepsy treatment. They didn't question it. That bought me a few weeks."

    show edward tense
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0843_im_f430eaaa7d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0853_greenwald_f202aea11b.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0856_e_42ff138980.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0858_im_e07a1f6a0a.mp3"  # edge-tts-auto
    ...
    if suspicion_level >= 3:
        ...
        show edward tense
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_0864_im_9fba6b0453.mp3"  # edge-tts-auto
        im "They know something is wrong. I can feel it. The clock is ticking."

    show greenwald resolved
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0867_greenwald_856184a386.mp3"  # edge-tts-auto
    greenwald "The documents check out. Laura and I have verified them. We're ready to publish."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0869_e_a0ffd41a0f.mp3"  # edge-tts-auto
    e "Publish everything. The world needs to see this."

    hide greenwald with dissolve

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0873_im_1a82afa0b8.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0875_im_cc4bad65ef.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0881_narrator_voice_2fc99a4f65.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0883_im_f274f9723a.mp3"  # edge-tts-auto
    ...
    menu:
        "Use the hotel Wi-Fi with a VPN.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0891_im_4221fa3f97.mp3"  # edge-tts-auto
        ...
        "Use a personal mobile hotspot with Tor.":
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_0901_im_b74b8a3db4.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0930_im_7009517a2f.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0932_im_7ba07d3870.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0936_im_c80174f51a.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0940_im_aa0fa0fdd0.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0942_im_fb3ec2252d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0948_im_42ad12653d.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0950_im_466ce82f6e.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0956_im_7907a52d1f.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0958_im_0276497936.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0964_im_409d291a67.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0966_im_496c65dfb7.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0972_im_fd788aa107.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0974_im_6e88ca9d7f.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0980_im_32fabfd8ab.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0986_im_52b6f1e4e0.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_0988_im_024564f07a.mp3"  # edge-tts-auto
    ...
    if escape_successful and evidence_secured:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1002_im_3859372be7.mp3"  # edge-tts-auto
        ...
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1005_im_5ac4855d9a.mp3"  # edge-tts-auto
        ...
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1008_im_a3ca16af5c.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1015_narrator_voice_c0ed9ef7b0.mp3"  # edge-tts-auto
    narrator_voice "The first stories are published. The world erupts. And now, you are the most wanted person on Earth."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1017_im_7cb44a3b64.mp3"  # edge-tts-auto
    im "The US government has revoked my passport. I need to move. Now."

    if suspicion_level >= 4:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1020_narrator_voice_1ca019e40c.mp3"  # edge-tts-auto
        ...
        menu:
            "Head to the airport immediately. Every minute counts.":
                ...
                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_1028_im_373a108d92.mp3"  # edge-tts-auto
            ...
            "Go to the Russian consulate. They're the only ones who might help.":
                ...
                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_1037_im_c20739e1c7.mp3"  # edge-tts-auto
        ...
        menu:
            "Fly to Ecuador via Moscow. Multiple stops make tracking harder.":
                ...
                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_1047_im_85f41313ab.mp3"  # edge-tts-auto
                im "Ecuador has a history of granting asylum to people the US wants. WikiLeaks arranged the route through Moscow."

                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_1049_narrator_voice_63c95dd554.mp3"  # edge-tts-auto
            ...
            "Seek asylum at a European embassy in Hong Kong.":
                ...
                if identity_exposed:
                    if should_play_english_voice():  # edge-tts-auto
                        voice "audio/voice/en/script_1058_narrator_voice_eac9e81ce5.mp3"  # edge-tts-auto
                    narrator_voice "With his identity already exposed, no embassy will risk the diplomatic fallout of harboring him."
                    $ escape_successful = False
                else:
                    if should_play_english_voice():  # edge-tts-auto
                        voice "audio/voice/en/script_1061_narrator_voice_faf752b7c7.mp3"  # edge-tts-auto
                    narrator_voice "The European embassies politely decline. No one wants to challenge the United States."
                    $ escape_successful = False

                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_1064_im_0fb2aafd5a.mp3"  # edge-tts-auto
            ...
            "Stay in Hong Kong and face the legal system.":
                ...
                if should_play_english_voice():  # edge-tts-auto
                    voice "audio/voice/en/script_1072_im_fbcbda69c0.mp3"  # edge-tts-auto
    ...
    if escape_successful and not identity_exposed:
        ...
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1079_narrator_voice_bb80e4e123.mp3"  # edge-tts-auto
...
label chapter_5:
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1121_narrator_voice_a9b3ec75a2.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1123_narrator_voice_90d75eae6e.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1128_russian_official_fee2762ea4.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1150_im_4240c79da5.mp3"  # edge-tts-auto
    im "I'm an exile in the physical world, but I've never been more active in the digital one."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1152_im_cc1fba4c7c.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1154_narrator_voice_2f99891ff7.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1156_im_7316c421bf.mp3"  # edge-tts-auto
    ...
    if trust_score >= 4:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1161_im_df1100e896.mp3"  # edge-tts-auto
        ...
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1163_im_2e2396c773.mp3"  # edge-tts-auto
        im "Trust is a calculation, not a feeling. I chose carefully, but not perfectly. Some bridges burned that didn't need to."
    else:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1165_im_c0c3f62357.mp3"  # edge-tts-auto
    ...
    if knowledge_score >= 7:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1168_im_64be99ee0e.mp3"  # edge-tts-auto
        ...
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1170_im_0781209f41.mp3"  # edge-tts-auto
        im "I knew enough to be dangerous, but not enough to be safe. There were gaps in my knowledge that almost got me caught."
    else:
        if should_play_english_voice():  # edge-tts-auto
            voice "audio/voice/en/script_1172_im_2d88396276.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1176_im_d00c37afd4.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1178_im_d82b159bee.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1188_im_ebcfa0ea2a.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1210_im_5a4fbdff18.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1212_im_f82ce3a470.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1227_narrator_voice_063805e805.mp3"  # edge-tts-auto
    narrator_voice "Years have passed. The world has changed — partly because of what you did, and partly in spite of it."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1229_narrator_voice_fa6dfd1c1f.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1232_im_9a65e09fb1.mp3"  # edge-tts-auto
    ...
    menu:
        "Encourage them to leak. The public deserves to know.":
            ...
            show edward determined
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_1238_e_4ec97c4fc2.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_1242_narrator_voice_9b7a0efd80.mp3"  # edge-tts-auto
        ...
        "Advise caution. Use official channels first.":
            ...
            show edward concerned
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_1247_e_d9a1a08964.mp3"  # edge-tts-auto
            ...
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_1252_narrator_voice_bd6fa239ee.mp3"  # edge-tts-auto
        ...
        "Tell them not to do it. The personal cost is too high.":
            ...
            show edward sad
            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_1257_e_51bf152075.mp3"  # edge-tts-auto
            e "I lost my country, my family, my freedom. I'd do it again, but I won't ask anyone else to pay that price."
            $ trust_score -= 1
            $ renpy.notify(t("Trust -1"))

            if should_play_english_voice():  # edge-tts-auto
                voice "audio/voice/en/script_1261_narrator_voice_f16f66cc19.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1269_narrator_voice_8e4ba5b403.mp3"  # edge-tts-auto
    narrator_voice "You remain in Russia. You were granted permanent residency in 2020 and Russian citizenship in 2022."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1271_narrator_voice_0e0e34e658.mp3"  # edge-tts-auto
    ...
    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1273_narrator_voice_e84ac7fa3a.mp3"  # edge-tts-auto
    narrator_voice "But mass surveillance continues in new forms. The debate between security and privacy is far from over."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1275_narrator_voice_42db98009f.mp3"  # edge-tts-auto
    narrator_voice "The tools you used — encryption, Tor, secure communication — are the same tools available to everyone."

    if should_play_english_voice():  # edge-tts-auto
        voice "audio/voice/en/script_1277_narrator_voice_5dac7a125e.mp3"  # edge-tts-auto
