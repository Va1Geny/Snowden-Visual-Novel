...
label intro:
    ...
    voice "audio/voice/en/script_0036_centered.mp3"
    ...
    voice "audio/voice/en/script_0044_narrator_voice.mp3"
    narrator_voice "The year is 2013."

    voice "audio/voice/en/script_0046_narrator_voice.mp3"
    narrator_voice "The United States government operates the most sophisticated surveillance network in human history."

    voice "audio/voice/en/script_0048_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0050_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0052_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0054_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0056_narrator_voice.mp3"
...
label chapter_1:
    ...
    voice "audio/voice/en/script_0087_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0090_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0096_im.mp3"
    ...
    voice "audio/voice/en/script_0098_im.mp3"
    ...
    voice "audio/voice/en/script_0107_e.mp3"
    e "Yes sir. I'll pull up the queue."

    voice "audio/voice/en/script_0109_supervisor.mp3"
    ...
    voice "audio/voice/en/script_0111_im.mp3"
    ...
    voice "audio/voice/en/script_0116_colleague.mp3"
    ...
    menu:
        "Follow protocol. Process the flagged selectors as assigned.":
            ...
            voice "audio/voice/en/script_0133_e.mp3"
            ...
            voice "audio/voice/en/script_0140_im.mp3"
            im "Stay in your lane. Do your job. Don't attract attention."

            voice "audio/voice/en/script_0142_narrator_voice.mp3"
        ...
        "Explore the restricted directories. Something doesn't add up.":
            ...
            voice "audio/voice/en/script_0146_e.mp3"
            ...
            voice "audio/voice/en/script_0153_im.mp3"
            ...
            voice "audio/voice/en/script_0155_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0160_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0162_im.mp3"
    ...
    voice "audio/voice/en/script_0164_im.mp3"
    ...
    voice "audio/voice/en/script_0168_im.mp3"
    ...
    voice "audio/voice/en/script_0170_im.mp3"
    ...
    voice "audio/voice/en/script_0172_im.mp3"
    ...
    voice "audio/voice/en/script_0174_sys.mp3"
    ...
    voice "audio/voice/en/script_0178_im.mp3"
    ...
    voice "audio/voice/en/script_0180_im.mp3"
    ...
    voice "audio/voice/en/script_0182_im.mp3"
    ...
    voice "audio/voice/en/script_0184_im.mp3"
    ...
    voice "audio/voice/en/script_0186_im.mp3"
    ...
    voice "audio/voice/en/script_0188_sys.mp3"
    sys "// SAFE PORTS (common services): 80 = HTTP | 443 = HTTPS | 53 = DNS | 22 = SSH | 3389 = RDP //"

    voice "audio/voice/en/script_0192_im.mp3"
    ...
    voice "audio/voice/en/script_0194_im.mp3"
    ...
    voice "audio/voice/en/script_0196_im.mp3"
    ...
    voice "audio/voice/en/script_0204_sys.mp3"
    ...
    voice "audio/voice/en/script_0235_im.mp3"
    ...
    menu:
        ...
        "Stay silent. Keep working. Gather more information.":
            ...
            voice "audio/voice/en/script_0277_im.mp3"
            ...
            voice "audio/voice/en/script_0281_narrator_voice.mp3"
...
label chapter_2:
    ...
    voice "audio/voice/en/script_0325_im.mp3"
    ...
    voice "audio/voice/en/script_0327_im.mp3"
    ...
    voice "audio/voice/en/script_0329_sys.mp3"
    ...
    voice "audio/voice/en/script_0331_im.mp3"
    ...
    voice "audio/voice/en/script_0333_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0335_sys.mp3"
    ...
    voice "audio/voice/en/script_0337_im.mp3"
    ...
    menu:
        "Trust the colleague. Share what you've found.":
            ...
            voice "audio/voice/en/script_0360_e.mp3"
            e "Look, I need someone I can trust. What I've found... it's bigger than both of us."
            $ trust_score += 1
            $ renpy.notify(t("Trust +1"))

            voice "audio/voice/en/script_0364_colleague.mp3"
    ...
    voice "audio/voice/en/script_0407_im.mp3"
    ...
    voice "audio/voice/en/script_0411_im.mp3"
    ...
    voice "audio/voice/en/script_0413_im.mp3"
    ...
    voice "audio/voice/en/script_0415_sys.mp3"
    sys "// SYSTEM NOTE: Caesar Cipher encryption with ROT-3: A→D, B→E, C→F, D→G ... X→A, Y→B, Z→C //"

    voice "audio/voice/en/script_0419_im.mp3"
    ...
    voice "audio/voice/en/script_0421_im.mp3"
    ...
    voice "audio/voice/en/script_0423_sys.mp3"
    ...
    voice "audio/voice/en/script_0427_im.mp3"
    ...
    voice "audio/voice/en/script_0429_im.mp3"
    ...
    voice "audio/voice/en/script_0431_sys.mp3"
    ...
    voice "audio/voice/en/script_0440_im.mp3"
    im "I have access to everything. The question is: what do I do with it?"

    voice "audio/voice/en/script_0442_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0444_im.mp3"
    ...
    menu:
        "Copy the files to an encrypted drive. This evidence needs to survive.":
            ...
            voice "audio/voice/en/script_0449_im.mp3"
            ...
            voice "audio/voice/en/script_0454_narrator_voice.mp3"
            ...
            voice "audio/voice/en/script_0456_im.mp3"
            ...
            voice "audio/voice/en/script_0458_sys.mp3"
        ...
        "Take detailed notes only. Digital evidence is too risky.":
            ...
            voice "audio/voice/en/script_0462_im.mp3"
            im "If they catch me with files, it's espionage. Notes are deniable."
            $ trust_score -= 1
            $ renpy.notify(t("Trust -1"))

            voice "audio/voice/en/script_0466_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0472_im.mp3"
    ...
    voice "audio/voice/en/script_0474_im.mp3"
...
label chapter_3:
    ...
    voice "audio/voice/en/script_0523_im.mp3"
    ...
    voice "audio/voice/en/script_0525_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0527_im.mp3"
    ...
    voice "audio/voice/en/script_0529_sys.mp3"
    ...
    voice "audio/voice/en/script_0531_im.mp3"
    ...
    voice "audio/voice/en/script_0562_im.mp3"
    ...
    voice "audio/voice/en/script_0564_narrator_voice.mp3"
...
label ch3_secure_success:
    voice "audio/voice/en/script_0587_im.mp3"
    ...
    voice "audio/voice/en/script_0589_sys.mp3"
    ...
    voice "audio/voice/en/script_0597_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0602_poitras.mp3"
    poitras "I received your encrypted message. The fingerprint checks out. Who are you?"

    voice "audio/voice/en/script_0604_e.mp3"
    ...
    voice "audio/voice/en/script_0607_poitras.mp3"
    poitras "Can you prove it?"

    voice "audio/voice/en/script_0609_e.mp3"
...
label ch3_contact_unsafe:
    ...
    voice "audio/voice/en/script_0669_im.mp3"
...
label ch3_continue:
    ...
    voice "audio/voice/en/script_0681_im.mp3"
    ...
    voice "audio/voice/en/script_0683_im.mp3"
    ...
    voice "audio/voice/en/script_0696_im.mp3"
    ...
    voice "audio/voice/en/script_0698_im.mp3"
    ...
    voice "audio/voice/en/script_0702_im.mp3"
    ...
    voice "audio/voice/en/script_0728_sys.mp3"
    ...
    voice "audio/voice/en/script_0758_narrator_voice.mp3"
    narrator_voice "The journalist asks for more details about the scope of the leaks."

    voice "audio/voice/en/script_0760_greenwald.mp3"
    ...
    menu:
        "Tell everything. Full transparency builds trust.":
            ...
            voice "audio/voice/en/script_0765_e.mp3"
            ...
            voice "audio/voice/en/script_0771_greenwald.mp3"
        ...
        "Be vague. Don't reveal the scope until you're safe.":
            ...
            voice "audio/voice/en/script_0783_e.mp3"
            e "It's significant. That's all I can say right now."
            $ trust_score -= 1
            $ renpy.notify(t("Trust -1"))

            voice "audio/voice/en/script_0787_greenwald.mp3"
...
label chapter_4:
    ...
    voice "audio/voice/en/script_0833_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0835_im.mp3"
    ...
    voice "audio/voice/en/script_0842_sys.mp3"
    ...
    voice "audio/voice/en/script_0850_greenwald.mp3"
    ...
    voice "audio/voice/en/script_0853_e.mp3"
    ...
    voice "audio/voice/en/script_0855_im.mp3"
    ...
    voice "audio/voice/en/script_0872_im.mp3"
    ...
    voice "audio/voice/en/script_0874_sys.mp3"
    ...
    voice "audio/voice/en/script_0878_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_0880_im.mp3"
    ...
    menu:
        "Use the hotel Wi-Fi with a VPN.":
            ...
            voice "audio/voice/en/script_0888_im.mp3"
        ...
        "Use a personal mobile hotspot with Tor.":
            ...
            voice "audio/voice/en/script_0898_im.mp3"
            ...
            voice "audio/voice/en/script_0900_sys.mp3"
            sys "// SECURE CONNECTION ESTABLISHED. TRAFFIC ROUTED THROUGH 3 TOR RELAY NODES. //"
            voice "audio/voice/en/script_0901_sys.mp3"
    ...
    voice "audio/voice/en/script_0927_im.mp3"
    ...
    voice "audio/voice/en/script_0929_im.mp3"
    ...
    voice "audio/voice/en/script_0933_im.mp3"
    ...
    voice "audio/voice/en/script_0937_im.mp3"
    ...
    voice "audio/voice/en/script_0939_im.mp3"
    ...
    voice "audio/voice/en/script_0947_im.mp3"
    ...
    voice "audio/voice/en/script_0949_sys.mp3"
    ...
    voice "audio/voice/en/script_0953_im.mp3"
    ...
    voice "audio/voice/en/script_0955_im.mp3"
    ...
    voice "audio/voice/en/script_0963_im.mp3"
    ...
    voice "audio/voice/en/script_0965_sys.mp3"
    ...
    voice "audio/voice/en/script_0969_im.mp3"
    ...
    voice "audio/voice/en/script_0971_im.mp3"
    ...
    voice "audio/voice/en/script_0985_im.mp3"
    ...
    voice "audio/voice/en/script_0987_sys.mp3"
    ...
    if escape_successful and evidence_secured:
        voice "audio/voice/en/script_0999_im.mp3"
    ...
    if escape_successful and not identity_exposed:
        ...
        voice "audio/voice/en/script_1076_narrator_voice.mp3"
...
label chapter_5:
    ...
    voice "audio/voice/en/script_1118_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_1120_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_1125_russian_official.mp3"
    ...
    voice "audio/voice/en/script_1151_narrator_voice.mp3"
    ...
    voice "audio/voice/en/script_1153_im.mp3"
    ...
    if trust_score >= 4:
        voice "audio/voice/en/script_1158_im.mp3"
    ...
    if knowledge_score >= 7:
        voice "audio/voice/en/script_1165_im.mp3"
    ...
    voice "audio/voice/en/script_1175_im.mp3"
    ...
    voice "audio/voice/en/script_1185_im.mp3"
    ...
    voice "audio/voice/en/script_1207_im.mp3"
    ...
    voice "audio/voice/en/script_1209_im.mp3"
    ...
    voice "audio/voice/en/script_1229_im.mp3"
    ...
    menu:
        "Encourage them to leak. The public deserves to know.":
            ...
            show edward determined
            voice "audio/voice/en/script_1235_e.mp3"
            ...
            voice "audio/voice/en/script_1239_narrator_voice.mp3"
        ...
        "Advise caution. Use official channels first.":
            ...
            show edward concerned
            voice "audio/voice/en/script_1244_e.mp3"
            ...
            voice "audio/voice/en/script_1249_narrator_voice.mp3"
